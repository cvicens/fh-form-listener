...
function attatch (formEventEmitter) {
  if (!formEventEmitter) {
    console.error ('No event emitter was found!');
    return;
  }

  formEventEmitter.on('submissionComplete', function(params){
  ...
  formEventEmitter.on('submissionError', function(error){
...
module.exports.attatch = attatch;